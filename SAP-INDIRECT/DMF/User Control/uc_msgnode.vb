Public Class uc_msgnode
    ...
    Private Sub RichTextBox2_MouseEnter(sender As Object, e As EventArgs) Handles RichTextBox2.MouseEnter
        MainMenu.lbl_hover.Visible = True
        MainMenu.lbl_hover.Text = "T: RTEXT" & " S:F SQLID:0 V:" & RichTextBox2.Text
    End Sub
    ...
    Private Sub uc_msgnode_MouseEnter(sender As Object, e As EventArgs) Handles Me.MouseEnter
        MainMenu.lbl_hover.Visible = True
        MainMenu.lbl_hover.Text = "T: MSGNDOE" & " S:F SQLID:0 V:" & RichTextBox2.Text
    End Sub

    Private Sub uc_msgnode_MouseLeave(sender As Object, e As EventArgs) Handles Me.MouseLeave
        MainMenu.lbl_hover.Visible = False
    End Sub

    Private Sub RichTextBox2_BackColorChanged(sender As Object, e As EventArgs) Handles RichTextBox2.BackColorChanged
        RichTextBox2.BackColor = Me.BackColor
    End Sub
End Class
