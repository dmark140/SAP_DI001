Public Class EDS_station
    ...
    Private Sub EDS_station_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MainMenu.MenuIcons_IsActive(MainMenu.btn_menu_add, True)

        EDS_SQL_PARAM.Clear()
        EDS_SQL_PARAM_ADD("@SQLID", "32")
        Dim iDt As DataTable = EDS_G_iSQL_TABLE()
        For i = 0 To iDt.Rows.Count - 1
            dgv_1.Rows.Add(dgv_1.Rows.Count + 1, iDt.Rows(i)("code"), iDt.Rows(i)("Station"))
        Next
        WrightAllCell()
    ...
    Private Sub btn_update_Click(sender As Object, e As EventArgs) Handles btn_update.Click
        ...
        EDS_SQL_PARAM.Clear()
        EDS_SQL_PARAM_ADD("@SQLID", "32") ''select
        Dim iDt As DataTable = EDS_G_iSQL_TABLE()
        For i = 0 To iDt.Rows.Count - 1
            dgv_1.Rows.Add(dgv_1.Rows.Count + 1, iDt.Rows(i)("code"), iDt.Rows(i)("station"))
        Next
