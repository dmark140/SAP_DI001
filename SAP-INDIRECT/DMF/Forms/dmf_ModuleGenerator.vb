Public Class dmf_ModuleGenerator
    ...
    Private Sub iCreate()
        ...
        Try
            ...
            iRecSet.DoQuery("select top 1 Code FROM [@OMUD] order by Code desc")
            ...
            iUDF = oCompany.UserTables.Item("OMUD")
            iUDF.Code = iCode + 1
            ...
            MainMenu.g_notif_panel(0, "Operation success Code : " & (iCode + 1) & " Name:" & (iCode + 1) & "_" & txt_Code.Text, 1)
    ...
    Private Sub tvNode_AfterSelect_1(sender As Object, e As TreeViewEventArgs) Handles tvNode.AfterSelect
