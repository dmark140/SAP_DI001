Public Class dmf_ModuleGenerator
    ...
    Private Sub iCreate()
        ...
        Try
            ...
            iRecSet.DoQuery("select top 1 convert(int , Code) [Code] FROM [@OMUD] order by convert(int , Code)  desc")
            ...
            iUDF.UserFields.Fields.Item("U_void").Value = "Y" '' active
            ' iUDF.UserFields.Fields.Item("U_isSupperuser").Value = "Y" '' active
