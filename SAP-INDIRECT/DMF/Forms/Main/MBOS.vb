    ...
    Sub iSelectCheckList(ByVal dateF As String, ByVal dateT As String)
        Try
            ...
            For i As Integer = 0 To iRecSet.Fields.Count - 1
                ADD_Column(iRecSet.Fields(i).Name, 1, i, iRecSet.Fields(i).Name, i, 30, dgv_CheckSelection, True)
                If Firstx = False Then ADD_Column(iRecSet.Fields(i).Name, 1, i, iRecSet.Fields(i).Name, i, 30, dgv_SelectedDocs, True)
            Next

            ADD_Column("C", 3, 0, "#", "num", 30, dgv_CheckSelection, True)
            If Firstx = False Then ADD_Column("C", 3, 0, "#", "num", 30, dgv_SelectedDocs, True)
