...
Public Class batch_selectionForm
    ...
    Private Sub batch_selectionForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Me.iStatus = "Close" Then
            Try
                ...
                G_iSQL_PARAMETERS.Add(IDOCNUM)
                G_iSQL_PARAMETERS.Add(ITEMX)
        ...
        Try
            ...
            G_iSQL_PARAMETERS.Clear()
            G_iSQL_PARAMETERS.Add(iItemc)
            G_iSQL_PARAMETERS.Add(iWhsec)
            ...
            Else
                ADD_Column(" Selected Qty ", 1, 2, "Selected Qty", 1, 15, dgv_selectorBatch, False)
                Col_MERROR()
    ...
    Sub Col_MERROR()
        ...
        For i = 0 To dgv_selectorBatch.Columns.Count - 1
            ADD_Column(dgv_selectorBatch.Columns(i).HeaderText, 1, i, dgv_selectorBatch.Columns(i).HeaderText, i, dgv_selectorBatch.Columns(i).Width, dgv_selected, True)
        Next
    End Sub
