Public Class PalletingFRM
    ...
    Public Function oConnect1() As Boolean
        ...
        Try
            ...
            oCompany.CompanyDB = "SBOIPIC_2111" ' Sql Database name
            oCompany.UserName = "manager" 'SAP username credentials 
            oCompany.Password = "P@ssw0rd" 'SAP password credentials 
            oCompany.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_MSSQL2014 'db server type
            oCompany.DbUserName = "sa"
            oCompany.DbPassword = "P@ssw0rd810~"
            oCompany.LicenseServer = "IPIC-SAP-SERVER"
