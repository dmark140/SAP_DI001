...
Public Class MBOS__CC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IpicIndirect.MBOS  CC.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TransIDSELECT_TransId__Details_FROM_vwDMF_S003() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedMBOS__CC
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MBOS__CC = New MBOS__CC()
        rpt.Site = Me.Site
        Return rpt
    End Function
