...
Public Class Proration___SR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IpicIndirect.Proration - SR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProration___SR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Proration___SR = New Proration___SR()
        rpt.Site = Me.Site
        Return rpt
    End Function
